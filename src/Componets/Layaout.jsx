    ...
    <div>
     {
      ...
      <div className="mobile">
        ...
        className='flex items-center w-15 justify-center outline-none h-6 bg-transparent text-white text-sm md:w-56 mt-3 rounded border-inherit mb-3 border-solid'
        type="text"
